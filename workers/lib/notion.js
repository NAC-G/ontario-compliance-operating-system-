...
function fcPhotosSchema(fcSitesDbId) {
  return {
    ...
    'Tags': multiSelect([
      ...
      'QC-FINISH','QC-INSTALL','QC-MATERIAL','QC-ALIGNMENT','QC-SPEC','QC-REWORK-DONE','QC-OK',
    ]),
    'OHSA References': rich_text,
    'Status': select(['Hazard - Open', 'Hazard - Corrected', 'Deficiency - Open', 'Deficiency - Corrected', 'Routine', 'Incident', 'Inspection']),
